...
from dgl.nn import SGConv, GATConv, TAGConv, GlobalAttentionPooling, AvgPooling, GraphConv,MaxPooling,SumPooling,EdgeConv
...
class Classifier(nn.Module):
    def __init__(self, in_dim, hidden_dim, n_classes):
        ...
        self.mlp=MLP(256+n_classes+2,n_classes)
        self.classify = Classify(256, n_classes)

    def forward(self, g):
        # 使用节点的入度作为初始特征
        h = g.ndata['h'].float()
        # h = F.relu(self.gcn0(g, h))
