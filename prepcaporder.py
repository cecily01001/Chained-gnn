...
def make_graph(data_dir_path, valid_data_dir_path, testdata_dir_path):
    ...
    validset = graphdataset(listofnodenum_valid, listofkind_valid, n_feature_matrix_valid,e_feature_matrix_valid,num_classes)
    testset = graphdataset(listofnodenum_test, listofkind_test, n_feature_matrix_test,e_feature_matrix_test,num_classes)
...
def main(kind):
    if kind == 'app':
        ...
        make_graph("Dataset/Splite_Session/Malware/trainset", "Dataset/Splite_Session/Malware/validset", "Dataset/Splite_Session/Malware/testset",'malware')
    else:
        make_graph("Dataset/Splite_Session/Entropy/train","Dataset/Splite_Session/Entropy/valid","Dataset/Splite_Session/Entropy/test",'entropy')
